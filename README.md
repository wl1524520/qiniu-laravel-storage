# Qiniu 云储存 Laravel 5 Storage 版

基于 https://github.com/zgldh/qiniu-laravel-storage 二次开发

符合 Laravel 5 的 Storage 用法。
...
### v0.7
- 增加了 ```withUploadToken```, ```lastReturn``` 等命令。
- 修正了代码内的一些typo
...
### v0.5
- 增加了```QiniuUrl```来更方便的设置文件 URL 参数。

### v0.3
- 增加了对PIPE以及回调地址参数的配置。 感谢abcsun提供的灵感。
